...
- blog
date: '2021-03-26'
description: Desde el CELE, celebramos este primer paso que está dando la Comisión para adentrarse en esta problemática y
  que lo haga con un proceso de diálogo abierto y multisectorial. De cara a este proceso que comienza resulta fundamental
  por un lado acercar a los Estados a este diálogo, en vista del creciente interés legislativo que existe en la materia; promover
  la participación de toda la región, incluido el Estado y la sociedad civil de Estados Unidos, que es donde muchas de estas
  plataformas tienen su base; y generar condiciones claras de igualdad para los diversos actores participantes en el proceso.
featured: true
image: /img/cidh-rele.jpg
programs:
- policy
slug: relatoria-especial-para-la-libertad-de-expresion
tags:
- institucional
title: Relatoría Especial para la libertad de Expresión
translationKey: wp-8407
type: posts
issues:
- LDE
- DDHH
