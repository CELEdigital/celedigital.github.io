...
programs:
- policy
slug: challenges-to-global-south-participation-in-european-unions-data-access-for-platform-researchers-consultation
tags:
- institucional
title: Challenges to Majority World Participation in European Union's Data Access for Platform Researchers Consultation
translationKey: wp-12146
type: posts
issues:
...
Seeking active and meaningful engagement in majority world countries requires a proactive approach. Although the answer to this question may not be entirely straightforward, several factors should be taken into account:
  ...
  * Mapping the ecosystem and working through existing networks: There is already an ecosystem that works on internet governance issues. Tapping into existing networks to disseminate consultation calls can be extremely useful. The [DSA alliance](https://www.eff.org/pages/dsa-human-rights-alliance) is putting some effort into this. However, engagement with decision making authorities remains essential. 
  ...
  * The recommendations set forth in the report of the [Task Force for a Trustworthy Future Web](https://www.atlanticcouncil.org/wp-content/uploads/2023/06/scaling-trust-on-the-web_executive-report.pdf) also come in handy, particularly those set forth in section 4: 
